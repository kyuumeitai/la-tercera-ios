...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemSelectedTitleColor = [UIColor colorWithRed:0.502f green:0.000f blue:1.000f alpha:1.0f];
        _itemIndicatorColor = [UIColor colorWithRed:0.502f green:0.000f blue:1.000f alpha:1.0f];
