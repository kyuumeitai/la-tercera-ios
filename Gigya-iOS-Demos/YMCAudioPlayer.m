 ...
 */
- (void)initPlayer:(NSURL*) audioFileURL
{
    NSData *objectData = [NSData dataWithContentsOfURL:audioFileURL];
    NSError *error;
    self.audioPlayer = (AVAudioPlayer*)  [AVPlayer playerWithURL:audioFileURL];
    
    self.audioPlayer = [[AVAudioPlayer alloc] initWithData:objectData
                                                     error:&error];
