//
//  LaTerceraTV-ActualidadTableViewController.m
//  La Tercera
//
...
#import "LaTerceraTV-ActualidadTableViewController.h"
...
@interface LaTerceraTV_ActualidadTableViewController ()
@property (strong, nonatomic) IBOutlet UITableView *tableView;
@end

@implementation LaTerceraTV_ActualidadTableViewController

@synthesize laTerceraTVActualidadArray;
...
//New Pagination code
int currentPageNumberTVActualidad ;
BOOL isPageRefreshingLaTerceraTVActualidad =  false;
BOOL firstTimeLaTerceraTVActualidad = false;

NSArray *bannersLaTerceraTVActualidad= nil;

BOOL _isScrollingLaTerceraTVActualidad;
int numeroPaginasTVActualidad;
NSString *dayTVActualidad;
NSString *monthTVActualidad;
NSString *yearTVActualidad;
NSString *storyBoardNameTVActualidad;

- (void)viewDidLoad {
    [super viewDidLoad];
    SessionManager *sesion = [SessionManager session];
    storyBoardNameTVActualidad = sesion.storyBoardName;
    ...
    NSLog(@" El nombre del storyboard es: %@", storyBoardNameTVActualidad);
    NSLog(@"CategoryId: %d", self.categoryId);
    __weak  LaTerceraTV_ActualidadTableViewController *weakSelf = self;
    laTerceraTVActualidadArray = [[NSMutableArray alloc] init];
    
    bannersLaTerceraTVActualidad = [NSArray arrayWithObjects:@"/124506296/La_Tercera_com/La_Tercera_com_APP/LaTerceraTVActualidad_300x250-A", @"/124506296/La_Tercera_com/La_Tercera_com_APP/LaTerceraTVActualidad_300x250-B", @"/124506296/La_Tercera_com/La_Tercera_com_APP/LaTerceraTVActualidad_300x250-C", @"/124506296/La_Tercera_com/La_Tercera_com_APP/LaTerceraTVActualidad_300x250-D", @"/124506296/La_Tercera_com/La_Tercera_com_APP/LaTerceraTVActualidad_300x250-E", nil];
    
    //Celda Grande
    UINib *cellNib ;
    
    if([storyBoardNameTVActualidad isEqualToString:@"LaTerceraStoryboard-iPhone4"] || [storyBoardNameTVActualidad isEqualToString:@"LaTerceraStoryboard-iPhone5"]){
    ...
    currentPageNumberTVActualidad = 1;
    firstTimeLaTerceraTVActualidad = true;
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return self.laTerceraTVActualidadArray.count;
}
...
-(void)loadHeadlinesWithCategory:(int)idCategory{
    ...
    [connectionManager getHeadlinesForCategoryId:^(BOOL success, NSArray *arrayJson, NSError *error){
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            if (!success) {
                if (isPageRefreshingLaTerceraTVActualidad == false){
                ...
                if(noData){
                    ...
                    isPageRefreshingLaTerceraTVActualidad = YES;
    ...
    }:idCategory andPage:currentPageNumberTVActualidad];
...
-(void) reloadHeadlinesDataFromArrayJson:(NSArray*)arrayJson{
    ...
    for (id titularTemp in arrayTitulares){
        ...
        NSLog(@"____ Numero de pagina: %d", currentPageNumberTVActualidad);
        if (indice == currentPageNumberTVActualidad*6 ){
            NSLog(@"____ currentPageNumberTVActualidad*6: %d", currentPageNumberTVActualidad*6);
            // [laTerceraTVActualidadArray addObject:@"OBJETO"];
        }
        [video logDescription];
        
        [laTerceraTVActualidadArray addObject:video];
    }
    
    //New code
    if (firstTimeLaTerceraTVActualidad ==true){
        self.view.alpha = 0.0;
        ...
        firstTimeLaTerceraTVActualidad= false;
    }else{
        ...
        [weakSelf.tableView.infiniteScrollingView stopAnimating];
        NSLog(@"LA cantidad es: %lu",(unsigned long)laTerceraTVActualidadArray.count);
    }
    NSLog(@" ******* RELOAD DATA TABLEEE Actualidad ****** ----------------------");
}
